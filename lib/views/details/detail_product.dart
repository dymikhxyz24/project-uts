...
import 'package:uts_project/views/carts/carts_product.dart';
import 'package:uts_project/helper/dbHelper.dart';
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                Text(
                  CurrencyFormat.convertToIdr(widget.price * 15000, 0),
